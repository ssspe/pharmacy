...
public class Requirement_1_2_3 {
	...
	public void AddingItemWithValidDailyDoseOf10() throws Exception {
		PrescriptionItem prescriptionItem = new PrescriptionItem("Medicine1", 10, 1, 1, false, "Comment");
	...
	public void AddingItemWithInvalidDailyDoseOf0() throws Exception {
		PrescriptionItem prescriptionItem = new PrescriptionItem("Medicine1", 0, 1, 1, false, "Comment");
	}
